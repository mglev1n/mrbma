...
Averaging. This is a form of multivariable Mendelian randomization which can be useful for prioritizing likely-causal risk factors among a set of highly-correlated exposures. This code adapts the approach described in:
...
You can install the development version of mrbma from [GitHub](https://github.com/) with:
