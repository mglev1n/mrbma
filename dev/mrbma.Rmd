...
```{r function-mrbma_remove_influential}
...
```{r tests-mrbma_remove_influential}

```
  

```{r function-mrbma_remove_outliers}
...
```{r tests-mrbma_remove_outliers}
```
    

# mrbma_nyholt_correct
    
```{r function-mrbma_nyholt_correct}
#' mrbma_nyholt_correct
#' 
